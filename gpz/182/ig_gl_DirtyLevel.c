...
build: clang -Wall -dynamiclib -o ig_gl_DirtyLevel.dylib ig_gl_DirtyLevel.c -framework IOKit -arch i386 -arch x86_64
run: DYLD_INSERT_LIBRARIES=./ig_gl_DirtyLevel.dylib  /Applications/Google\ Chrome.app/Contents/MacOS/Google\ Chrome --single-process --url "http://codepen.io/ma77os/full/spekH"
*/
