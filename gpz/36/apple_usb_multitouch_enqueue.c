/*
clang -o apple_usb_multitouch_enqueue apple_usb_multitouch_enqueue.c -framework IOKit
...
int main(){
  ...
  buf[0] = 0x34567890; // queueSize
  buf[1] = 0x12345678; // head
  buf[2] = 0x23456780; // tail
